...
Обновлено: 2026-04-21 (после пересмотра бизнес-модели)
Источники: KNOWLEDGE.md обоих репо + PRODUCT.secauditai.md + `decisions/business-model-review.md`

## Что за продукт
SaaS генерация ИБ-документации за 5 минут. 6 типов документов: политика ИБ, NDA, матрица рисков, план реагирования на инциденты, чеклист аудита, письмо директору о необходимости ИБ. Домен: **secauditai.ru**. Состояние на апрель 2026 — MVP задеплоен, архитектура стабильна, все P0/P1 security-замечания закрыты. Ждёт ЮКассу + переориентацию ЦА по итогам пересмотра модели.

## Стратегическая рамка (после ревью 2026-04-21)

**ЦА v1 «одинокий безопасник в компании 50-500» признана ошибочной.**
Причины:
- Он наёмный сотрудник, бюджет не его.
- Покупка онлайн 2990/мес за свои — отказ в 95% случаев.
- Потребность разовая (раз в 2-3 года) — не создаёт recurring.
- LTV/CAC ≈ 0.88 при SaaS-минимуме 3 — юнит-экономика отрицательная.

**Новая ЦА (Сценарий B)**: ИП-консультанты по ИБ + малые юрфирмы для SMB,
обслуживающие 10-20 клиентов. У них:
- бюджет и мандат покупать online,
- рекуррентное использование (документы — их рабочий инструмент),
- ARPU 3000-15000, retention ≥12 мес, LTV/CAC ≥ 3.

**Цель пересмотрена**: MRR **120к через 12 мес, 175к через 18 мес** (было
175к через 12 мес — нереалистично при реальной ёмкости ниши и CAC).

**Точка решения**: неделя 4 после публикации анонса. Критерии — 5+ интервью
с настоящей ЦА + 2-3 согласных платить. Если сигнал отрицательный → Сценарий
C (пивот через активы: Legal RAG как monitor, AI-генерация как AI Draft для
HR/юристов, /audit как B2B API для страховых) или SecAudit → passive income
50-80к + фокус на другой продукт.

Полный анализ: `decisions/business-model-review.md`.
Kill-criteria (из PRODUCT.md) теперь относится к Сценарию B-запуску, не
к старой модели: если за 60 дней после пере-позиционирования 0 платящих
консультантов → активируем C.

## Тарифы (текущие в коде — меняются после подтверждения ЦА)
Сейчас:
- **Free** — 0 руб, 1 документ без карты
- **Старт** 1490/мес — 5 документов
- **Про** 2990/мес — безлимит + DOCX
- **Команда** 6990/мес — до 3 компаний (disabled «В разработке»)

После подтверждения ЦА консультанты (Сценарий B):
- **Free** — 1 документ, lead magnet
- **Консультант Start** 2990/мес — до 5 клиентов
- **Консультант Pro** 6990/мес — до 20 клиентов
- **Консультант Unlimited** 14900/мес — безлимит клиентов
- Команда 6990 как отдельный план — упраздняется (multi-tenant у всех).

Разовая покупка «Пакет 4990» — **не добавляется**. Решение утром 2026-04-21
отменено после полного пересмотра модели.
